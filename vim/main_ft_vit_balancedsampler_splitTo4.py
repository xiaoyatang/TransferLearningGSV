...
from engine_splitTo4 import train_one_epoch, evaluate
from losses import DistillationLoss
from samplers import RASampler,BalancedRASampler,GroupDistributedSampler, BalancedGroupRASampler
...
def get_args_parser():
    ...
    parser.add_argument('--data-path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--data_set', default='STREET', choices=['CIFAR', 'IMNET', 'INAT', 'INAT19', 'STREET','GREEN30','SIDEWALKS'],
    ...
    parser.add_argument('--gsv_split_to_four',  action='store_true')  # Whether or not
    # to split the original input (640x440) to 4 of (372,256), retaining aspect ratio.
    return parser
...
def main(args):
    ...
    if args.distributed:
        ...
        if args.repeated_aug:
            ...
            sampler_train = GroupDistributedSampler(
                dataset_train, num_replicas=num_tasks, rank=global_rank, shuffle=True
            )
        if args.dist_eval:
            ...
            sampler_val = GroupDistributedSampler(
            ...
            for k in ["head.weight", "head.bias", "head_dist.weight", "head_dist.bias"]:
                if k in checkpoint_model and k in state_dict:
                    if checkpoint_model[k].shape != state_dict[k].shape:
                        ...
                        print(f"✅ Keeping fine-tuned head '{k}' with shape {checkpoint_model[k].shape}.")
        else:
    ...
    criterion = DistillationLoss(
        torch.nn.BCEWithLogitsLoss(), teacher_model, args.distillation_type, args.distillation_alpha, args.distillation_tau
    )
    ...
    if args.eval:
        ...
        print(
            ...
            f"balanced_acc={test_stats['balanced_accuracy']:.2f}, "
            f"f1={test_stats['f1']:.2f}, "
