...
def get_args_parser():
    ...
    parser.add_argument('--data-path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--data_set', default='STREET', choices=['CIFAR', 'IMNET', 'INAT', 'INAT19', 'STREET'],
...
def main(args):
    ...
    for name, param in model.named_parameters():
        if 'blocks' in name or 'layers' in name:  # Adjust prefix to match your model
            ...
            print("fc1.weight norm:", model.head.fc1.weight.norm())
            print("fc2.weight norm:", model.head.fc2.weight.norm()) 
