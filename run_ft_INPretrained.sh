...
#SBATCH --output=/uu/sci.utah.edu/projects/DeepLearning/Xiaoya_GSV/Vim/output/resume0524/slurm-%j.out
#SBATCH --error=/uu/sci.utah.edu/projects/DeepLearning/Xiaoya_GSV/Vim/output/resume0524/slurm-%j.err
...
--use_env /uu/sci.utah.edu/projects/DeepLearning/Xiaoya_GSV/Vim/vim/main.py --model \
...
--output_dir \
/uu/sci.utah.edu/projects/DeepLearning/Xiaoya_GSV/unsupervised_pretrained_models_eval/streetlight18k/output \
--epochs 30 --finetune /uu/sci.utah.edu/projects/DeepLearning/Xiaoya_GSV/Vim/vim_s_midclstok_ft_81p6acc.pth --no_amp
