...
#SBATCH --output=/uufs/sci.utah.edu/projects/DeepLearning/Xiaoya_GSV/Vim/output/IN_balanced/slurm-%j.out
#SBATCH --error=/uufs/sci.utah.edu/projects/DeepLearning/Xiaoya_GSV/Vim/output/IN_balanced/slurm-%j.err
...
--use_env /uufs/sci.utah.edu/projects/DeepLearning/Xiaoya_GSV/Vim/vim/main_balancedsampler.py --model \
...
--output_dir \
/uufs/sci.utah.edu/projects/DeepLearning/Xiaoya_GSV/Vim/output/IN_balanced \
--epochs 50 --finetune /uufs/sci.utah.edu/projects/DeepLearning/Xiaoya_GSV/Vim/vim_s_midclstok_ft_81p6acc.pth --no_amp
