...
#SBATCH --output=/uu/sci.utah.edu/projects/DeepLearning/Xiaoya_GSV/Vim/output/IN_balanced/eval_slurm-%j.out
#SBATCH --error=/uu/sci.utah.edu/projects/DeepLearning/Xiaoya_GSV/Vim/output/IN_balanced/eval_slurm-%j.err
...
--use_env /uu/sci.utah.edu/projects/DeepLearning/Xiaoya_GSV/Vim/vim/main_balancedsampler.py --eval --resume \
/uu/sci.utah.edu/projects/DeepLearning/Xiaoya_GSV/Vim/output/IN_balanced/best_checkpoint.pth \
